...
from .models import Project, Transaction, category as Category, accounts as Asset, UserCorrection
...
def index():
    ...
    assets = Asset.query.order_by(Asset.account_name).all()

    return render_template('project/index.html', pagination=pagination, search_query=search_query, per_page=per_page, assets=assets)
...
def project_details(project_id):
    ...
    return render_template('project/project_details.html', project=project_instance, highlight_id=highlight_id)
